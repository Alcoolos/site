...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\CocktailRepository' => function () {
    return ($this->privates['App\Repository\CocktailRepository'] ?? $this->load('getCocktailRepositoryService.php'));
}, 'App\\Repository\\NotesRepository' => function () {
    return ($this->privates['App\Repository\NotesRepository'] ?? $this->load('getNotesRepositoryService.php'));
}, 'App\\Repository\\ProduitRepository' => function () {
